...
std::shared_ptr<simple::renderable> hlayout(std::vector<std::shared_ptr<simple::renderable>> elements) {
	return std::make_shared<simple::horizontal_layout>(std::move(elements));
}
